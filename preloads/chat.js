...
function createCatalog(ops) {
    return {
        ...
        regenerateAgentTopicTitle: query((agentId, topicId) => ops.invoke('regenerate-agent-topic-title', agentId, topicId)),
        ...
        onLoomShareTextToInput: subscription(ops.subscribe('loom:share-text-to-input', (_event, text) => text)),
        ...
        regenerateGroupTopicTitle: query((groupId, topicId) => ops.invoke('regenerate-group-topic-title', groupId, topicId)),
        ...
        startJevGroupChat: query((groupId, topicId) => ops.invoke('start-jev-group-chat', groupId, topicId)),
        continueJevGroupChat: query((groupId, topicId) => ops.invoke('continue-jev-group-chat', groupId, topicId)),
        enqueueJevGroupAgent: query((groupId, topicId, agentId) => ops.invoke('enqueue-jev-group-agent', groupId, topicId, agentId)),
        getJevGroupChatState: query((groupId, topicId) => ops.invoke('get-jev-group-chat-state', groupId, topicId)),
        ...
        interruptGroupChatQueue: query((groupId, topicId) => ops.invoke('interrupt-group-chat-queue', groupId, topicId)),
        ...
        onVoiceInputGlobalToggle: subscription(ops.subscribe('voice-input-global-toggle', (_event, data) => data)),
        onVoiceInputShortcutStatus: subscription(ops.subscribe('voice-input-shortcut-status', (_event, data) => data)),
        onVoiceInputCapturedText: subscription(ops.subscribe('voice-input-captured-text', (_event, data) => data)),
        startNativeVoiceInput: query((options = {}) => ops.invoke('voice-input-native:start', options)),
        stopNativeVoiceInput: query((options = {}) => ops.invoke('voice-input-native:stop', options)),
        cancelNativeVoiceInput: query(() => ops.invoke('voice-input-native:cancel')),
        getNativeVoiceInputStatus: query(() => ops.invoke('voice-input-native:status')),
        ...
        watcherBegin: query(() => ops.invoke('watcher:begin')),
        watcherStart: query((filePath, agentId, topicId, leaseToken = null) => ops.invoke('watcher:start', filePath, agentId, topicId, leaseToken)),
        watcherStop: query((leaseToken = null) => ops.invoke('watcher:stop', leaseToken)),
...
const ALLOWED_KEYS = [
    ...
    "onVoiceInputGlobalToggle",
    "onVoiceInputShortcutStatus",
    "onVoiceInputCapturedText",
    "startNativeVoiceInput",
    "stopNativeVoiceInput",
    "cancelNativeVoiceInput",
    "getNativeVoiceInputStatus",
