...
> 状态：历史页面迁移方案，当前不实施。业务子页面 Next runtime 没有生产消费者，首个主窗口 PR 将按 [`next-ui-development-roadmap.md`](./next-ui-development-roadmap.md) 做减法；未来只允许页面、runtime 与测试在同一独立 PR 引入。
> 基线日期：2026-08-01
