...
export function mountRiskConfirmation(props: RiskConfirmationProps, scope: UiScope): RiskConfirmationController {
    ...
    cancel.type = 'button'; cancel.className = 'vcp-harness-risk-modal-action'; cancel.textContent = props.cancelLabel;
    const confirm = document.createElement('button');
    confirm.type = 'button'; confirm.className = 'vcp-harness-risk-confirm-action'; confirm.textContent = props.confirmLabel;
