...
const VCP_NAMES: Readonly<Record<UiuxSemanticIconName, string>> = {
...
export function mountSemanticIcon(host: HTMLElement, props: SemanticIconProps, scope: UiScope): SemanticIconController {
    ...
    return {
        ...
        setName(value) { if (!VCP_NAMES[value]) throw new TypeError(`Unknown Uiux semantic icon: ${value}`); name = value; render(); },
