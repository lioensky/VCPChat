...
import { mountSemanticIcon, type UiuxSemanticIconName } from '../primitives/semantic-icon.js';
...
export function mountPrimitiveLab(root: HTMLElement, scope: UiScope): UiDisposer {
    ...
    let directory: ReturnType<typeof mountDirectoryBrowser>;
    ...
    let risk: ReturnType<typeof mountRiskConfirmation>;
    ...
    (['warning', 'close', 'check', 'chevron-down'] as const satisfies readonly UiuxSemanticIconName[]).forEach(name => {
        const fixture = document.createElement('span');
